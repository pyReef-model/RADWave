...
latex_documents = [
    (master_doc, "RADWave.tex", u"RADWave Documentation", u"Tristan Salles", "manual"),
]
...
man_pages = [(master_doc, "radwave", u"RADWave Documentation", [author], 1)]
